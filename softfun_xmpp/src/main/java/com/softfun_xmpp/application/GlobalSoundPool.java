...
public class GlobalSoundPool {
    ...
    private static void init(){
        if((Build.VERSION.SDK_INT) >= Build.VERSION_CODES.LOLLIPOP){
            //System.out.println("====================  1、Build.VERSION.SDK_INT  ====================="+Build.VERSION.SDK_INT+"   "+Build.VERSION_CODES.LOLLIPOP);
            ...
            //System.out.println("====================  2、Build.VERSION.SDK_INT  ====================="+Build.VERSION.SDK_INT+"   "+Build.VERSION_CODES.LOLLIPOP);
