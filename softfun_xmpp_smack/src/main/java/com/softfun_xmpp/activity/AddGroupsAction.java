        ...
        switch(v.getId() )
        {
            case R.id.bt_reject:
                ...
                ThreadUtils.runInThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            MultiUserChatManager multiUserChatManager = MultiUserChatManager.getInstanceFor(IMService.conn);
                            multiUserChatManager.decline( mRoomJid, mFromAccount, "抱歉，我不想加入。");
