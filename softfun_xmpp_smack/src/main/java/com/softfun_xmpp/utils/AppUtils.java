...
public final class AppUtils {
    ...
    public static String getPackageName(Context context){
        ...
        String packageName = "";
        try {
            mPkg = context.getPackageManager().getPackageInfo(context.getPackageName(), 0);
            if(mPkg!=null){
                packageName = mPkg.packageName;
            }else{
                packageName = "";
            }
    ...
    public static int gc(Context context) {
        ...
        if (DEBUG) {
            System.out.println("清理了" + (getDeviceUsableMemory(context) - i) + "M内存");
        }
        return count;
    }
