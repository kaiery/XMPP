...
public class SubscriberControlFragment extends Fragment implements
    ...
    public void initSubscriberUI() {
        if (openTokActivity != null ) {
            ...
            //获取对方的nickname
            mSubscriberName.setText(openTokActivity.mTargetNickName);
//            mSubscriberName.setText(openTokActivity.getSubscriber().getStream().getName());
            mSubscriberMute.setImageResource(openTokActivity.getSubscriber().getSubscribeToAudio() ? R.drawable.unmute_sub
                    : R.drawable.mute_sub);
        }
    }
